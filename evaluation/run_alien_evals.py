"""
run_alien_evals.py  —  Run the alien clinic MCQ evaluation N times and average the results.
"""
import sys, os, time, concurrent.futures, statistics

sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

import alien_mcq_eval as ev
